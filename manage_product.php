<?php 
    ...
    if(isset($_POST['submit'])){
         ...
         if(($_FILES['image']['type']!='image/jpg')  && ($_FILES['image']['type']!='image/jpeg') && ($_FILES['image']['type']!='image/png') && ($_FILES['image']['type']!='')){
                 $msg="Please Only png, jpg, and jpeg files are allowed";
         }
         ...
         if($msg==''){
            if(isset($_GET['id']) && $_GET['id']!=''){
               if($_FILES['image']['name']!=''){
                  ...
                  $update_sql="update product set categories_id='$categories_id', name='$name',mrp='$mrp',price='$price',qty='$qty',image='$image',
            ...
            <div class="card">
               ...
               <div class="card-body card-block">
                  ...
                  <label for="image" class=" form-control-label">Image</label>
                     ...
                     placeholder="" <?php echo  $image_reqired ?> >
                  </div>
